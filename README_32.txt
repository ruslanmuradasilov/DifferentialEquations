...
4. Описание исходного кода.
	...
	Функции реализованные в файле odu_01_36.c:
        ...
        4. int find_interval(double a, double b, double c, double d, double h, double *yz_last, double *result, double *left,
                              double *right)
        ...
        5. void shoot(double a, double b, double c, double d, double h, double eps, double *yz_last, double *result, double left,
